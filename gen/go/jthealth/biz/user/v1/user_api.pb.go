...
type GetGetUserInfosListResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetGetUserInfosListResponse) Reset() {
	*x = GetGetUserInfosListResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetGetUserInfosListResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetGetUserInfosListResponse) ProtoMessage() {}

func (x *GetGetUserInfosListResponse) ProtoReflect() protoreflect.Message {
	mi := &file_jthealth_biz_user_v1_user_api_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetGetUserInfosListResponse.ProtoReflect.Descriptor instead.
func (*GetGetUserInfosListResponse) Descriptor() ([]byte, []int) {
	return file_jthealth_biz_user_v1_user_api_proto_rawDescGZIP(), []int{18}
}

func (x *GetGetUserInfosListResponse) GetPageNum() int32 {
	if x != nil {
		return x.PageNum
	}
	return 0
...
func (x *GetGetUserInfosListResponse) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *GetGetUserInfosListResponse) GetTotal() int32 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *GetGetUserInfosListResponse) GetList() []*UserMsg {
	if x != nil {
		return x.List
	}
	return nil
...
var file_jthealth_biz_user_v1_user_api_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x22, 0x56, 0x0a, 0x18, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x46, 0x65, 0x61, 0x74,
	...
	0x66, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x54, 0x79, 0x70, 0x65, 0x22, 0x33, 0x0a, 0x19, 0x41,
	...
	0x28, 0x09, 0x52, 0x0a, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x9e,
	0x01, 0x0a, 0x1b, 0x47, 0x65, 0x74, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66,
	...
	0x4b, 0x65, 0x79, 0x32, 0xa6, 0x08, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x41, 0x50, 0x49, 0x12,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x74, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49,
	...
	0x65, 0x74, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x73, 0x4c, 0x69,
	...
	0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x62, 0x69, 0x7a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	0x76, 0x31, 0x2e, 0x41, 0x70, 0x70, 0x6c, 0x79, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x41,
	0x75, 0x64, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x9d, 0x01, 0x0a,
...
var file_jthealth_biz_user_v1_user_api_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_jthealth_biz_user_v1_user_api_proto_goTypes = []interface{}{
	...
	(*GetGetUserInfosListResponse)(nil), // 18: jthealth.biz.user.v1.GetGetUserInfosListResponse
...
var file_jthealth_biz_user_v1_user_api_proto_depIdxs = []int32{
	...
	19, // 1: jthealth.biz.user.v1.GetGetUserInfosListResponse.list:type_name -> jthealth.biz.user.v1.UserMsg
	0,  // 2: jthealth.biz.user.v1.UserAPI.SignInByPhoneCode:input_type -> jthealth.biz.user.v1.SignInByPhoneCodeRequest
	6,  // 3: jthealth.biz.user.v1.UserAPI.SignInByPassWord:input_type -> jthealth.biz.user.v1.SignInByPassWordRequest
	2,  // 4: jthealth.biz.user.v1.UserAPI.GetUserInfosById:input_type -> jthealth.biz.user.v1.GetUserInfosByIdRequest
	4,  // 5: jthealth.biz.user.v1.UserAPI.UpdateUserInfos:input_type -> jthealth.biz.user.v1.UpdateUserInfosRequest
	13, // 6: jthealth.biz.user.v1.UserAPI.CreatedUserProfile:input_type -> jthealth.biz.user.v1.CreatedUserProfileRequest
	17, // 7: jthealth.biz.user.v1.UserAPI.GetUserInfosList:input_type -> jthealth.biz.user.v1.GetUserInfosListRequest
	8,  // 8: jthealth.biz.user.v1.UserAPI.ApplyApplication:input_type -> jthealth.biz.user.v1.ApplyApplicationRequest
	10, // 9: jthealth.biz.user.v1.UserAPI.GetApplicationInfo:input_type -> jthealth.biz.user.v1.GetApplicationInfoRequest
	15, // 10: jthealth.biz.user.v1.UserAPI.ApplyFeatureAudit:input_type -> jthealth.biz.user.v1.ApplyFeatureAuditRequest
	1,  // 11: jthealth.biz.user.v1.UserAPI.SignInByPhoneCode:output_type -> jthealth.biz.user.v1.SignInByPhoneCodeResponse
	7,  // 12: jthealth.biz.user.v1.UserAPI.SignInByPassWord:output_type -> jthealth.biz.user.v1.SignInByPassWordResponse
	3,  // 13: jthealth.biz.user.v1.UserAPI.GetUserInfosById:output_type -> jthealth.biz.user.v1.GetUserInfosByIdResponse
	5,  // 14: jthealth.biz.user.v1.UserAPI.UpdateUserInfos:output_type -> jthealth.biz.user.v1.UpdateUserInfosResponse
	14, // 15: jthealth.biz.user.v1.UserAPI.CreatedUserProfile:output_type -> jthealth.biz.user.v1.CreatedUserProfileResponse
	18, // 16: jthealth.biz.user.v1.UserAPI.GetUserInfosList:output_type -> jthealth.biz.user.v1.GetGetUserInfosListResponse
	9,  // 17: jthealth.biz.user.v1.UserAPI.ApplyApplication:output_type -> jthealth.biz.user.v1.ApplyApplicationResponse
	11, // 18: jthealth.biz.user.v1.UserAPI.GetApplicationInfo:output_type -> jthealth.biz.user.v1.GetApplicationInfoResponse
	16, // 19: jthealth.biz.user.v1.UserAPI.ApplyFeatureAudit:output_type -> jthealth.biz.user.v1.ApplyFeatureAuditResponse
...
func file_jthealth_biz_user_v1_user_api_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_jthealth_biz_user_v1_user_api_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetGetUserInfosListResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
