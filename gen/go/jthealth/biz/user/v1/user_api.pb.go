...
var file_jthealth_biz_user_v1_user_api_proto_rawDesc = []byte{
	...
	0x72, 0x65, 0x74, 0x32, 0x8e, 0x0b, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x41, 0x50, 0x49, 0x12,
	...
	,
	...
	0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x31, 0x2e, 0x6a, 0x74, 0x68, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x2e, 0x62, 0x69, 0x7a, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e,
	0x47, 0x65, 0x74, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x41, 0x75, 0x64, 0x69, 0x74, 0x4c,
	0x69, 0x73, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x77, 0x0a, 0x12, 0x55,
	0x70, 0x64, 0x61, 0x74, 0x65, 0x46, 0x65, 0x61, 0x74, 0x75, 0x72, 0x65, 0x41, 0x75, 0x64, 0x69,
	0x74, 0x12, 0x2f, 0x2e, 0x6a, 0x74, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x62, 0x69, 0x7a,
...
var file_jthealth_biz_user_v1_user_api_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
...
var file_jthealth_biz_user_v1_user_api_proto_depIdxs = []int32{
	...
	0,  // 3: jthealth.biz.user.v1.UserAPI.SignInByPhoneCode:input_type -> jthealth.biz.user.v1.SignInByPhoneCodeRequest
	6,  // 4: jthealth.biz.user.v1.UserAPI.SignInByPassWord:input_type -> jthealth.biz.user.v1.SignInByPassWordRequest
	2,  // 5: jthealth.biz.user.v1.UserAPI.GetUserInfosById:input_type -> jthealth.biz.user.v1.GetUserInfosByIdRequest
	4,  // 6: jthealth.biz.user.v1.UserAPI.UpdateUserInfos:input_type -> jthealth.biz.user.v1.UpdateUserInfosRequest
	13, // 7: jthealth.biz.user.v1.UserAPI.CreatedUserProfile:input_type -> jthealth.biz.user.v1.CreatedUserProfileRequest
	17, // 8: jthealth.biz.user.v1.UserAPI.GetUserInfosList:input_type -> jthealth.biz.user.v1.GetUserInfosListRequest
	8,  // 9: jthealth.biz.user.v1.UserAPI.ApplyApplication:input_type -> jthealth.biz.user.v1.ApplyApplicationRequest
	10, // 10: jthealth.biz.user.v1.UserAPI.GetApplicationInfo:input_type -> jthealth.biz.user.v1.GetApplicationInfoRequest
	25, // 11: jthealth.biz.user.v1.UserAPI.RestAppSecretById:input_type -> jthealth.biz.user.v1.RestAppSecretByIdRequest
	15, // 12: jthealth.biz.user.v1.UserAPI.ApplyFeatureAudit:input_type -> jthealth.biz.user.v1.ApplyFeatureAuditRequest
	20, // 13: jthealth.biz.user.v1.UserAPI.GetFeatureAuditList:input_type -> jthealth.biz.user.v1.GetFeatureAuditListRequest
	23, // 14: jthealth.biz.user.v1.UserAPI.UpdateFeatureAudit:input_type -> jthealth.biz.user.v1.UpdateFeatureAuditRequest
	1,  // 15: jthealth.biz.user.v1.UserAPI.SignInByPhoneCode:output_type -> jthealth.biz.user.v1.SignInByPhoneCodeResponse
	7,  // 16: jthealth.biz.user.v1.UserAPI.SignInByPassWord:output_type -> jthealth.biz.user.v1.SignInByPassWordResponse
	3,  // 17: jthealth.biz.user.v1.UserAPI.GetUserInfosById:output_type -> jthealth.biz.user.v1.GetUserInfosByIdResponse
	5,  // 18: jthealth.biz.user.v1.UserAPI.UpdateUserInfos:output_type -> jthealth.biz.user.v1.UpdateUserInfosResponse
	14, // 19: jthealth.biz.user.v1.UserAPI.CreatedUserProfile:output_type -> jthealth.biz.user.v1.CreatedUserProfileResponse
	18, // 20: jthealth.biz.user.v1.UserAPI.GetUserInfosList:output_type -> jthealth.biz.user.v1.GetUserInfosListResponse
	9,  // 21: jthealth.biz.user.v1.UserAPI.ApplyApplication:output_type -> jthealth.biz.user.v1.ApplyApplicationResponse
	11, // 22: jthealth.biz.user.v1.UserAPI.GetApplicationInfo:output_type -> jthealth.biz.user.v1.GetApplicationInfoResponse
	26, // 23: jthealth.biz.user.v1.UserAPI.RestAppSecretById:output_type -> jthealth.biz.user.v1.RestAppSecretByIdResponse
	16, // 24: jthealth.biz.user.v1.UserAPI.ApplyFeatureAudit:output_type -> jthealth.biz.user.v1.ApplyFeatureAuditResponse
	21, // 25: jthealth.biz.user.v1.UserAPI.GetFeatureAuditList:output_type -> jthealth.biz.user.v1.GetFeatureAuditListResponse
	24, // 26: jthealth.biz.user.v1.UserAPI.UpdateFeatureAudit:output_type -> jthealth.biz.user.v1.UpdateFeatureAuditResponse
